...
/*    private void signOut() {
    ...
    private void signIn() {
        ...
        startActivityForResult(signInIntent, RC_SIGN_IN); //prompts user for email, pwd, scopes, etc.
        Log.w(TAG, "starting sign in");
    }


    /*
     * After activity of startActivityForResult is finished, onActivityResult is called.
     * We get user's GoogleSignInAccount object in this method
     */
    @Override
